...
interface TransformOption {
  minZoom: number; maxZoom: number; minPitch: number; maxPitch: number; renderWorldCopies: boolean;
}

const defaultOptions = {
  minZoom: 0, maxZoom: 22, minPitch: 0, maxPitch: 60, renderWorldCopies: true
}
/**
...
export class Transform {
    ...
    constructor(option: TransformOption = {} as any) {
      const {minZoom, maxZoom, minPitch, maxPitch, renderWorldCopies} = Object.assign({}, defaultOptions, option);
